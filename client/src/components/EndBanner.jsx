...
const EndBanner = () => {
  return (
    <section className="bg-indigo-dark md:py-16 p-8">
      <div className="flex md:flex-row flex-col gap-3 justify-between items-center md:w-2/3 mx-auto">
        <div>
          <h2 className="uppercase text-sky-500 flex items-center text-sm text">
            Collaborate with us
          </h2>
          <h2 className="text-4xl text-gray-100 font-semibold my-3">Start sending quality invoices</h2>
