...
const Confirm = () => {
  ...
  return (
    <section className="h-screen w-screen bg-indigo-dark flex flex-col justify-center items-center text-gray-200">
      <p className="md:text-6xl text-3xl font-bold capitalize">{message.split('-').join(' ')}!</p>
      {/* <div className="w-fit mx-auto bg-gray-900 rounded-xl text-indigo-400 p-5 my-5 text-3xl text-center">
        chillpill@gmail.com
      </div> */}
      <button onClick={() => navigate('/')} className="bg-sky-500 px-6 py-2 rounded font-semibold md:mt-8 mt-5">Go To Home</button>
    </section>
  );
};
